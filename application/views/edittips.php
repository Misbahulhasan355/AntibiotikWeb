<div id="page-wrapper">
     ...
     <div class="col-md-12 span_3">
          <div class="bs-example1" data-example-id="contextual-table">
           ...
           <form class="form-horizontal" action="<?php echo base_url(). 'Admin/update_tips'; ?>" method="post">
      ...
      <div class="col-sm-8 col-sm-offset-2">
        <button class="btn-success btn" value="update_tips">Submit</button><a href="<?php echo base_url('Admin/darurat');?>"><button class="btn-inverse btn">Cancel</button></a>
      </div>
   </div>
    </form></div>
