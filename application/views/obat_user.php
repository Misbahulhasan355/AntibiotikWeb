<div id="page-wrapper">
     ...
     <div class="col-md-12 span_3">
          <div class="bs-example1" data-example-id="contextual-table">
            <form class="form-horizontal" action="<?php echo base_url(). 'User/tambah_aksiobat'; ?>" method="post">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                foreach ($lemari as $u) { 
                  ...
                  <td><?php echo anchor('User/edit_obat/'.$u->id_obat,'<button type="button" class="btn btn-danger"><i class="fa fa-pencil"></i></button>'); ?>
  &nbsp;</td>
                </tr>
                <?php } ?>
              </tbody>
